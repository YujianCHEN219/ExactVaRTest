...
Freely extends to CoVaR backtesting: pass the institution’s hit sequence on system‑VaR‑breach days into `backtest_lr()` for exact UC/IND p‑values. 
* for short windows or extreme tails, you may treat the systemic‑breach count as random and apply the mixture test to maintain correct size. (see one example in vignettes and [Francq & Zakoïan 2025]).
